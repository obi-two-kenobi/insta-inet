...
SOURCES       = camerWorker.cpp \
		...
		inetcontroler.cpp \
		serverWorker.cpp \
		videoWorker.cpp moc_camerWorker.cpp \
		moc_discoveryWorker.cpp \
		moc_imageWorker.cpp \
		moc_inetcontroler.cpp \
		moc_serverWorker.cpp \
		moc_videoWorker.cpp
OBJECTS       = camerWorker.o \
		discoveryWorker.o \
		imageWorker.o \
		insta-inet.o \
		main.o \
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		inetControlPanel.pro camerWorker.h \
		discoveryWorker.h \
		imageWorker.h \
		inetcontroler.h \
		insta-inet.h \
		serverWorker.h \
		videoWorker.h camerWorker.cpp \
		discoveryWorker.cpp \
		imageWorker.cpp \
		insta-inet.cpp \
		main.cpp \
...
inetControlPanel.app/Contents/Info.plist: 
	...
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,Ali.inetControlPanel,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},Ali.inetControlPanel,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,MyIcon.icns,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},MyIcon.icns,g" -e "s,@EXECUTABLE@,inetControlPanel,g" -e "s,@LIBRARY@,inetControlPanel,g" -e "s,\$${EXECUTABLE_NAME},inetControlPanel,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >inetControlPanel.app/Contents/Info.plist
inetControlPanel.app/Contents/Resources/MyIcon.icns: MyIcon.icns
	@test -d inetControlPanel.app/Contents/Resources/ || mkdir -p inetControlPanel.app/Contents/Resources/
	@$(DEL_FILE) inetControlPanel.app/Contents/Resources/MyIcon.icns
	@$(COPY_FILE) MyIcon.icns inetControlPanel.app/Contents/Resources/MyIcon.icns

all: Makefile \
		inetControlPanel.app/Contents/PkgInfo \
		inetControlPanel.app/Contents/Info.plist \
		inetControlPanel.app/Contents/Resources/MyIcon.icns inetControlPanel.app/Contents/MacOS/inetControlPanel
...
distdir: FORCE
	...
	$(COPY_FILE) --parents camerWorker.h discoveryWorker.h imageWorker.h inetcontroler.h insta-inet.h serverWorker.h videoWorker.h $(DISTDIR)/
	$(COPY_FILE) --parents camerWorker.cpp discoveryWorker.cpp imageWorker.cpp insta-inet.cpp main.cpp inetcontroler.cpp serverWorker.cpp videoWorker.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_camerWorker.cpp moc_discoveryWorker.cpp moc_imageWorker.cpp moc_inetcontroler.cpp moc_serverWorker.cpp moc_videoWorker.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_camerWorker.cpp moc_discoveryWorker.cpp moc_imageWorker.cpp moc_inetcontroler.cpp moc_serverWorker.cpp moc_videoWorker.cpp
moc_camerWorker.cpp: camerWorker.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/alis/Documents/Codes/QT/inetControlPanel/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/alis/Documents/Codes/QT/inetControlPanel -I/opt/homebrew/Cellar/opencv/4.12.0_1/include/opencv4 -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/17/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib camerWorker.h -o moc_camerWorker.cpp

moc_discoveryWorker.cpp: discoveryWorker.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h \
		insta-inet.h \
		/opt/homebrew/Cellar/opencv/4.12.0_1/include/opencv4/opencv2/opencv.hpp \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/alis/Documents/Codes/QT/inetControlPanel/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/alis/Documents/Codes/QT/inetControlPanel -I/opt/homebrew/Cellar/opencv/4.12.0_1/include/opencv4 -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/17/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib discoveryWorker.h -o moc_discoveryWorker.cpp
...
moc_serverWorker.cpp: serverWorker.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h \
		insta-inet.h \
		/opt/homebrew/Cellar/opencv/4.12.0_1/include/opencv4/opencv2/opencv.hpp \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/alis/Documents/Codes/QT/inetControlPanel/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/alis/Documents/Codes/QT/inetControlPanel -I/opt/homebrew/Cellar/opencv/4.12.0_1/include/opencv4 -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/17/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib serverWorker.h -o moc_serverWorker.cpp
...
camerWorker.o: camerWorker.cpp camerWorker.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QGraphicsView \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qgraphicsview.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h \
		...
		/opt/homebrew/Cellar/opencv/4.12.0_1/include/opencv4/opencv2/video/background_segm.hpp \
		insta-inet.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o camerWorker.o camerWorker.cpp

discoveryWorker.o: discoveryWorker.cpp discoveryWorker.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h \
		insta-inet.h \
		/opt/homebrew/Cellar/opencv/4.12.0_1/include/opencv4/opencv2/opencv.hpp \
		...
		/opt/homebrew/Cellar/opencv/4.12.0_1/include/opencv4/opencv2/video/tracking.hpp \
		/opt/homebrew/Cellar/opencv/4.12.0_1/include/opencv4/opencv2/video/background_segm.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o discoveryWorker.o discoveryWorker.cpp
...
serverWorker.o: serverWorker.cpp serverWorker.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h \
		insta-inet.h \
		/opt/homebrew/Cellar/opencv/4.12.0_1/include/opencv4/opencv2/opencv.hpp \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QDebug \
		/opt/homebrew/lib/QtCore.framework/Headers/qdebug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o serverWorker.o serverWorker.cpp
...
moc_camerWorker.o: moc_camerWorker.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_camerWorker.o moc_camerWorker.cpp

moc_discoveryWorker.o: moc_discoveryWorker.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_discoveryWorker.o moc_discoveryWorker.cpp
